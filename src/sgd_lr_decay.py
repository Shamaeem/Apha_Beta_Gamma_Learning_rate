...
class SGDLRDecay(Optimizer):
    ...
    def __init__(self, params, scheme, eta0, alpha, milestones=[], T_max=0,
        ...
        if scheme == 'exp':
            ...
            self.get_lr_func = lambda cur_lr, t, eta0, alpha, milestones, T_max, gamma, coeff: (math.tan((T_max-t)*math.pi/(4*T_max))) * eta0
        elif scheme == 'tan2':
            self.get_lr_func = lambda cur_lr, t, eta0, alpha, milestones, T_max, gamma, coeff: (1-math.tan(t*math.pi/(4*T_max))) * eta0
        elif scheme == 'tan3':
            self.get_lr_func = lambda cur_lr, t, eta0, alpha, milestones, T_max, gamma, coeff: (math.sqrt(3)-math.tan(t*math.pi/(3*T_max))) * eta0/(math.sqrt(3))
